...
//     description: "Generate professional resumes tailored to your experience and target role in seconds.",
//   },
//   {
//     icon: Mail,
//     title: "Cover Letter Generator",
//     description: "Write compelling, personalized cover letters that match job descriptions perfectly.",
//   },
//   {
//     icon: BarChart3,
//     title: "ATS Analyzer",
//     description: "Get instant feedback on how well your resume passes applicant tracking systems.",
//   },
//   {
//     icon: Briefcase,
//     title: "Job Search",
//     description: "Search thousands of jobs across the UK, US, Canada, and Australia.",
//   },
//   {
//     icon: TrendingUp,
//     title: "Career Insights",
//     description: "Track your progress and get actionable recommendations to improve your chances.",
//   },
// ];

// const steps = [
//   { number: "01", title: "Enter Your Details", description: "Tell us about your experience, skills, and target role." },
//   { number: "02", title: "AI Generates Content", description: "Our AI crafts professional resumes and cover letters instantly." },
//   { number: "03", title: "Download & Apply", description: "Export as PDF and start applying to your dream jobs." },
// ];
...
//             <br />
//             <span className="text-text-primary">That Get Noticed</span>
//           </motion.h1>
...
//           >
//             Generate professional resumes, write compelling cover letters, and find your next opportunity — all powered by AI.
//           </motion.p>
...
//             <Link
//               href="/signup"
//               className="inline-flex items-center gap-2 px-8 py-4 rounded-xl bg-accent text-black font-semibold text-lg hover:bg-accent-dark transition-all shadow-[0_0_30px_rgba(0,194,255,0.3)] hover:shadow-[0_0_40px_rgba(0,194,255,0.5)]"
//             >
//               Get Started Free
...
//             <Link
//               href="#how-it-works"
//               className="inline-flex items-center gap-2 px-8 py-4 rounded-xl border border-border text-text-secondary hover:text-text-primary hover:border-border-bright transition-all"
//             >
...
//                 <div className="ml-auto text-xs text-text-tertiary">resume.pdf</div>
//               </div>
...
//                 <div className="px-3 py-1 rounded-full bg-accent/20 text-accent text-xs">ATS Score: 94</div>
//                 <div className="px-3 py-1 rounded-full bg-success/20 text-success text-xs">Strong</div>
//               </div>
//             </div>
//           </motion.div>
//         </div>
...
//               A complete toolkit for every stage of your job search journey.
//             </p>
//           </motion.div>
...
//                 className="glass-card rounded-xl p-6 hover:shadow-[0_0_30px_rgba(0,194,255,0.08)] transition-all duration-200 group"
//               >
//                 <div className="w-12 h-12 rounded-xl bg-accent/10 border border-accent/20 flex items-center justify-center mb-4 group-hover:shadow-[0_0_20px_rgba(0,194,255,0.15)] transition-shadow">
...
//                 >
//                   <div className="w-16 h-16 rounded-2xl bg-accent/10 border border-accent/20 flex items-center justify-center shrink-0 z-10">
...
//           >
//             <div>
//               <p className="text-4xl sm:text-5xl font-bold text-accent mb-2">10,000+</p>
//               <p className="text-sm text-text-secondary">Resumes Generated</p>
//             </div>
//             <div className="hidden md:block w-px h-16 bg-border" />
//             <div>
//               <p className="text-4xl sm:text-5xl font-bold text-accent mb-2">95%</p>
//               <p className="text-sm text-text-secondary">ATS Pass Rate</p>
//             </div>
//             <div className="hidden md:block w-px h-16 bg-border" />
//             <div>
//               <p className="text-4xl sm:text-5xl font-bold text-accent mb-2">4.9★</p>
...
//           >
//             <h2 className="text-3xl sm:text-4xl font-bold text-text-primary mb-4">
//               Ready to build your <span className="text-gradient">career</span>?
//             </h2>
//             <p className="text-text-secondary mb-8 max-w-lg mx-auto">
//               Join thousands of professionals who have accelerated their job search with MyCareerKits.
//             </p>
//             <Link
//               href="/signup"
//               className="inline-flex items-center gap-2 px-8 py-4 rounded-xl bg-accent text-black font-semibold text-lg hover:bg-accent-dark transition-all shadow-[0_0_30px_rgba(0,194,255,0.3)] hover:shadow-[0_0_40px_rgba(0,194,255,0.5)]"

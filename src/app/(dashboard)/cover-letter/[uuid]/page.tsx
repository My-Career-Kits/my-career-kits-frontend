...
// import { Pencil, Check, X, Trash2, BarChart3, Save } from "lucide-react";
...
//       <div className="max-w-4xl mx-auto">
//         <div className="mb-6">
//           <h1 className="text-2xl font-bold text-text-primary">{coverLetter.title}</h1>
...
//                 className="w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg border border-red-800 hover:bg-red-950 text-red-400 text-sm font-medium transition-all"
//               >
...
//         },
//       });
//       // Only close editor on success; keep it open so user doesn't lose changes on failure
//       setIsEditing(false);
//     } catch {

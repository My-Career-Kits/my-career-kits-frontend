...
//     await mutation.mutateAsync(uuid);
//   };

//   const isAnalyzing = mutation.isPending;
//   const hasAnalysis = query.isSuccess && query.data;
//   const noAnalysis = query.isError || (!query.data && !query.isLoading && !isAnalyzing);

//   return (
//     <PageTransition>
//       <div className="max-w-3xl mx-auto">
//         <button
//           onClick={() => router.push(`/cover-letter/${uuid}`)}
...
//         {query.isError && query.error && (query.error as { response?: { status: number } }).response?.status !== 404 && (
//           <ErrorAlert message="Failed to load analysis" onRetry={() => query.refetch()} />
//         )}

//         {noAnalysis && !isAnalyzing && (
//           <EmptyState
...
//               <CoverLetterAnalysisPanel analysis={query.data} />

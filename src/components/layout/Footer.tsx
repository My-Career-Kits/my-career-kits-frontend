...
//                 <span
//                   key={country.code}
//                   className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs border border-border text-text-secondary hover:border-border-bright hover:shadow-[0_0_10px_rgba(0,194,255,0.08)] transition-all cursor-default"
//                 >
...
//                 className="w-8 h-8 rounded-lg border border-border flex items-center justify-center text-text-secondary hover:text-accent hover:border-accent/30 transition-all"
//               >

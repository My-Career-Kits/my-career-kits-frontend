...
//     if (status === 503 || status === 502) return "AI service is temporarily unavailable. Please try again in a moment.";
//     if (status === 404) return "Not found.";
//     if (status === 400) return "Please check your input and try again.";
//     if (!error.response) return "You appear to be offline. Check your connection.";
//   }
...
//       return Object.values(data.errors).flat().join(" ");
//     }
//     if (typeof data?.error === "string") return data.error; // handles singular "error" key
//     if (data?.detail) return data.detail;
//     const status = error.response?.status;
//     if (status === 503 || status === 502) return "AI service is temporarily unavailable. Please try again in a moment.";
//     if (status === 404) return "Not found.";
